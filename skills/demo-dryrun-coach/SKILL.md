...
|------|---------------------|
| **Knowledge base** | Checks your demo steps against the latest product capabilities and known limitations |
...
SHOW (first-person narration) — Does the SC narrate AS the customer, not ABOUT them?
  ✅ Good: "I am Sarah. I open ${user_config.product_a}. I see my queue. I click Run."
...
TELL (the value) — Is the outcome clearly stated and quantified?
  ✅ Good: "That's 50 new product launches classified in hours, not months."
...
LIKELY OBJECTION 2: [e.g. "We already have something that does classification"]
...
------------------------------|---------|-----------|------
Opening / Picture Pitch       |         |           | Keep to ≤5 min
Module 1                      |         |           |
Module 2                      |         |           |
Module 3                      |         |           |
...
- [ ] Picture Pitch is drafted — one image, anchored to their current-state pain
