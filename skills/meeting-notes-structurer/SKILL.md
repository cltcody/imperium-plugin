...
description: |
  Structures raw customer-meeting notes — ${user_config.qualification_framework} updates, next
  steps, red flags, and a follow-up email. Use on "structure these notes", "what are the action
