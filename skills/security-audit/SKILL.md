...
name: security-audit
description: |
  Full defensive security audit of a codebase or change-set with severity-rated findings. Use on
  "security audit", "is this secure", "check for vulnerabilities", or before a release or
  compliance sign-off.
context: fork
